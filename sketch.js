...
function preload() {
  ...
  groundImage = loadImage("bg1.png");

  marioImage = loadAnimation("0.png", "1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png");

  mario1 = loadImage("1.png");

  blockImage = loadImage("blockImg.png");

  coinSound = loadSound("coinsound.mp3");
  
  obstacleImage = loadImage("ob.gif");
